<template>
	<div class="addEdit-block" :style='{"padding":"30px 30px 30px 240px","background":"none","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="售后单号" prop="shouhoudanhao">
					<el-input v-model="ruleForm.shouhoudanhao" placeholder="售后单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shouhoudanhao" label="售后单号" prop="shouhoudanhao">
					<el-input v-model="ruleForm.shouhoudanhao" placeholder="售后单号" readonly></el-input>
				</el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.shenqingyuanyin = this.ruleForm.shenqingyuanyin.replace(reg,'../../../springbootgqon2/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
