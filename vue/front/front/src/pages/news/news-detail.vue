<template>
  <div :style='{"border":"1px solid #dfdfdf","padding":"20px","margin":"20px auto 0","borderRadius":"16px","background":"#fff","width":"1200px","position":"relative"}'>
    <div class="section-title" :style='{"margin":"0px 0","color":"#ffffff","borderRadius":"8px 8px 0 0","textAlign":"center","background-color":"#FF6B9D","fontSize":"24px","lineHeight":"150px","fontWeight":"bold"}'>通知公告</div>
