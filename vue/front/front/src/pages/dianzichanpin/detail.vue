		...
		<div class="attr" :style='{"border":"1px solid #dfdfdf","padding":"16px 16px 20px 16px","boxShadow":"1px 2px 3px #eee","margin":"20px 0 20px 0","overflow":"hidden","borderRadius":"16px","background":"#fff","position":"relative"}'>
			...
			<div class="zancai" :style='{"padding":"0","margin":"0","top":"428px","background":"none","width":"540px","position":"absolute","right":"20px"}'>
				<div :style='{"border":"1px solid #dfdfdf","cursor":"pointer","padding":"10px 0","boxShadow":"1px 2px 3px #eee","margin":"0 auto 12px auto","alignItems":"center","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)","display":"flex","width":"30%","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="zan" @click="thumbsupOrCrazily(21)">
					<i :style='{"color":"#FF6B9D","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-dianzan"></i>
					<span :style='{"color":"#666","margin":"0 4px","fontSize":"14px"}'>赞一下({{detail.thumbsupnum}})</span>
				</div>
				<div :style='{"border":"1px solid #dfdfdf","cursor":"pointer","padding":"10px 0","boxShadow":"1px 2px 3px #eee","margin":"0 auto 12px auto","alignItems":"center","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)","display":"flex","width":"30%","justifyContent":"center"}' v-if="!isThumbsupnum && !isCrazilynum" class="cai" @click="thumbsupOrCrazily(22)">
					<i :style='{"color":"#FF6B9D","margin":"0 3px","fontSize":"14px"}' class="iconfont icon-iconfontzan"></i>
			...
			<div class="info" :style='{"minHeight":"520px","width":"600px","padding":"0px 0 20px","margin":"0px","float":"left","background":"#fff"}'>
				...
				<div class="item" :style='{"border":"1px solid #dfdfdf","padding":"0px 10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)","display":"flex","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"width":"120px","padding":"0 10px","fontSize":"14px","lineHeight":"40px","color":"#666","textAlign":"right"}'>保修期</div>
					<div  :style='{"width":"498px","padding":"8px 10px 0","fontSize":"14px","lineHeight":"24px","color":"#999","height":"auto"}'>{{detail.baoxiuqi}}</div>
				</div>
				<div class="item" :style='{"border":"1px solid #dfdfdf","padding":"0px 10px","boxShadow":"1px 2px 3px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"radial-gradient(circle, rgba(246,246,246,1) 0%, rgba(230,230,230,1) 100%)","display":"flex","justifyContent":"spaceBetween"}'>
				...
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					...
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"rgba(255, 107, 157, 1)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="detail.alllimittimes" type="warning" size="small" @click="addCart">添加到购物车</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 0 0","outline":"none","color":"#fff","borderRadius":"4px","background":"rgba(255, 107, 157, 1)","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="detail.alllimittimes" type="warning" size="small" @click="buyNow">立即购买</el-button>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
				</div>
			</div>
  ...
  export default {
    ...
    methods: {
      ...
      storeup(type) {
        if (type == 1 && !this.isStoreup) {
          ...
          this.storeupParams.inteltype = this.detail.chanpinleibie;
    ...
    getThumbsupOrCrazilyStatus() {
      ...
      addCart() {
        ...
        this.cart.goodtype = this.detail.chanpinleibie;
        ...
        buyNow() {
            ...
            localStorage.setItem('orderGoods', JSON.stringify([{
                ...
                goodname: this.title,
                goodtype: this.detail.chanpinleibie,
...
<style rel="stylesheet/scss" lang="scss" scoped>
	...
	.detail-preview .detail.el-tabs .add ::v-deep .el-textarea__inner {
		...
		border-radius: 4px;
		padding: 4px 12px;
		box-shadow: 0 0 0px rgba(255, 107, 157, .5);
		outline: none;
		color: #333;
		background: none;
		width: 1058px;
